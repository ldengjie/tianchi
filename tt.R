...
for(ti in 4:8)
{
    ...
    for(si in st)
    {
        ...
        if(ti==5)
        {
            tsam<-arima(tsdata,order=or,xreg=xregfit,io=c(13,61))
        }else if(ti==7)
        {
        ...
        while(needFix)
        {
            ...
            if(needFix)
            {
                ...
                if(ti==5)
                {
                    tsam<-arima(tsdata,order=or,xreg=xregfit,fixed=fixedv,transform.pars = FALSE,io=c(13,61))
                }else if(ti==7)
                {
    ...
    if(ti==5)
    {
        tsam.bestfit<-arima(tsdata,order=or,xreg=xregfit,fixed=fixb,transform.pars = FALSE,io=c(13,61));
...
#plot(as.zoo(cbind(
#xts(exp(icard11)+exp(icard12)+exp(icard13)+exp(icard14)+exp(icard15)+exp(icard16)+exp(icard17),seq(as.POSIXct("2014-04-01"),len=length(icard11),by='day')),
#xts(exp(icard11),seq(as.POSIXct("2014-04-01"),len=length(icard11),by='day')),
#xts(exp(icard12),seq(as.POSIXct("2014-04-01"),len=length(icard12),by='day')),
#xts(exp(icard13),seq(as.POSIXct("2014-04-01"),len=length(icard13),by='day')),
#xts(exp(icard14),seq(as.POSIXct("2014-04-01"),len=length(icard14),by='day')),
#xts(exp(icard15),seq(as.POSIXct("2014-04-01"),len=length(icard15),by='day')),
#xts(exp(icard16),seq(as.POSIXct("2014-04-01"),len=length(icard16),by='day')),
#xts(exp(icard17),seq(as.POSIXct("2014-04-01"),len=length(icard17),by='day')),
#xts(exp(icard21)+exp(icard22)+exp(icard23)+exp(icard24)+exp(icard25)+exp(icard26)+exp(icard27),seq(as.POSIXct("2014-04-01"),len=length(icard21),by='day')),
#xts(exp(icard21),seq(as.POSIXct("2014-04-01"),len=length(icard21),by='day')),
#xts(exp(icard22),seq(as.POSIXct("2014-04-01"),len=length(icard22),by='day')),
#xts(exp(icard23),seq(as.POSIXct("2014-04-01"),len=length(icard23),by='day')),
#xts(exp(icard24),seq(as.POSIXct("2014-04-01"),len=length(icard24),by='day')),
#xts(exp(icard25),seq(as.POSIXct("2014-04-01"),len=length(icard25),by='day')),
#xts(exp(icard26),seq(as.POSIXct("2014-04-01"),len=length(icard26),by='day')),
#xts(exp(icard27),seq(as.POSIXct("2014-04-01"),len=length(icard27),by='day')),
#xts(exp(icard31)+exp(icard32)+exp(icard33)+exp(icard34)+exp(icard35)+exp(icard36)+exp(icard37),seq(as.POSIXct("2014-04-01"),len=length(icard31),by='day')),
#xts(exp(icard31),seq(as.POSIXct("2014-04-01"),len=length(icard31),by='day')),
#xts(exp(icard32),seq(as.POSIXct("2014-04-01"),len=length(icard32),by='day')),
#xts(exp(icard33),seq(as.POSIXct("2014-04-01"),len=length(icard33),by='day')),
#xts(exp(icard34),seq(as.POSIXct("2014-04-01"),len=length(icard34),by='day')),
#xts(exp(icard35),seq(as.POSIXct("2014-04-01"),len=length(icard35),by='day')),
#xts(exp(icard36),seq(as.POSIXct("2014-04-01"),len=length(icard36),by='day')),
#xts(exp(icard37),seq(as.POSIXct("2014-04-01"),len=length(icard37),by='day'))
...
for(ti in 2:7)
{
    ...
    for(si in st)
    {
        ...
        if(ti==4)
        {
            tsam<-arima(tsdata,order=or,xreg=xregfit,io=c(33))
        }else
        {
            tsam<-arima(tsdata,order=or,xreg=xregfit)
        }
