...
fd$zfb11[which(fd$zfb11 ==0)]<-100
fd$zfb12[which(fd$zfb12 ==0)]<-100
fd$zfb13[which(fd$zfb13 ==0)]<-100
fd$zfb14[which(fd$zfb14 ==0)]<-100
fd$zfb15[which(fd$zfb15 ==0)]<-100
fd$zfb16[which(fd$zfb16 ==0)]<-100
fd$zfb17[which(fd$zfb17 ==0)]<-100
fd$zfb21[which(fd$zfb21 ==0)]<-100
fd$zfb22[which(fd$zfb22 ==0)]<-100
fd$zfb23[which(fd$zfb23 ==0)]<-100
fd$zfb24[which(fd$zfb24 ==0)]<-100
fd$zfb25[which(fd$zfb25 ==0)]<-100
fd$zfb26[which(fd$zfb26 ==0)]<-100
fd$zfb27[which(fd$zfb27 ==0)]<-100
fd$zfb31[which(fd$zfb31 ==0)]<-100
fd$zfb32[which(fd$zfb32 ==0)]<-100
fd$zfb33[which(fd$zfb33 ==0)]<-100
fd$zfb34[which(fd$zfb34 ==0)]<-100
fd$zfb35[which(fd$zfb35 ==0)]<-100
fd$zfb36[which(fd$zfb36 ==0)]<-100
fd$zfb37[which(fd$zfb37 ==0)]<-100
fd$bank11[which(fd$bank11==0)]<-100
fd$bank12[which(fd$bank12==0)]<-100
fd$bank13[which(fd$bank13==0)]<-100
fd$bank14[which(fd$bank14==0)]<-100
fd$bank15[which(fd$bank15==0)]<-100
fd$bank16[which(fd$bank16==0)]<-100
fd$bank17[which(fd$bank17==0)]<-100
fd$bank21[which(fd$bank21==0)]<-100
fd$bank22[which(fd$bank22==0)]<-100
fd$bank23[which(fd$bank23==0)]<-100
fd$bank24[which(fd$bank24==0)]<-100
fd$bank25[which(fd$bank25==0)]<-100
fd$bank26[which(fd$bank26==0)]<-100
fd$bank27[which(fd$bank27==0)]<-100
fd$bank31[which(fd$bank31==0)]<-100
fd$bank32[which(fd$bank32==0)]<-100
fd$bank33[which(fd$bank33==0)]<-100
fd$bank34[which(fd$bank34==0)]<-100
fd$bank35[which(fd$bank35==0)]<-100
fd$bank36[which(fd$bank36==0)]<-100
fd$bank37[which(fd$bank37==0)]<-100
...
tslist<-list(total_purchase_amt, izfb11, izfb12, izfb13, izfb14, izfb15, izfb16, izfb17, izfb21, izfb22, izfb23, izfb24, izfb25, izfb26, izfb27, izfb31, izfb32, izfb33, izfb34, izfb35, izfb36, izfb37, ibank11, ibank12, ibank13, ibank14, ibank15, ibank16, ibank17, ibank21, ibank22, ibank23, ibank24, ibank25, ibank26, ibank27, ibank31, ibank32, ibank33, ibank34, ibank35, ibank36, ibank37, share)
type<-list("total_purchase_amt","izfb11","izfb12","izfb13","izfb14","izfb15","izfb16","izfb17","izfb21","izfb22","izfb23","izfb24","izfb25","izfb26","izfb27","izfb31","izfb32","izfb33","izfb34","izfb35","izfb36","izfb37","ibank11","ibank12","ibank13","ibank14","ibank15","ibank16","ibank17","ibank21","ibank22","ibank23","ibank24","ibank25","ibank26","ibank27","ibank31","ibank32","ibank33","ibank34","ibank35","ibank36","ibank37","share")
#sorderlist<-list(c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0),c(0,0,0))
orderlist<-list(c(0,0,0)
                ,c(0,0,0),c(4,0,4),c(3,0,6),c(0,0,0),c(0,0,0),c(0,0,0),c(4,0,6)
                ,c(0,0,0),c(0,0,0),c(0,0,0),c(4,0,4),c(0,0,0),c(0,0,0),c(0,0,0)
                ,c(0,0,0),c(0,0,0),c(0,0,0),c(2,0,2),c(3,1,1),c(6,1,1),c(7,0,7)
                ,c(0,0,0),c(7,0,7),c(4,0,4),c(1,0,1),c(0,0,0),c(0,0,0),c(0,0,0)
                ,c(0,0,0),c(1,0,1),c(0,0,0),c(1,0,1),c(1,0,1),c(1,0,1),c(0,0,0)
                ,c(1,0,1),c(0,0,0),c(0,0,0),c(0,0,0),c(2,0,2),c(4,0,4),c(0,0,0)
                ,c(1,1,7))
...
for(ti in 2:44)
{
    ...
    for(si in st)
    {
        ...
        #}else if(ti==7)
        #{
            #tsam<-arima(tsdata,order=or,xreg=xregfit,io=c(33,101))
        #}else if(ti==8)
        #{
        ...
        while(needFix)
        {
            ...
            if(needFix)
            {
                ...
                #}else if(ti==7)
                #{
                    #tsam<-arima(tsdata,order=or,xreg=xregfit,fixed=fixedv,transform.pars = FALSE,io=c(33,101))
                #}else if(ti==8)
                #{
    ...
    #}else if(ti==7)
    #{
        #tsam.bestfit<-arima(tsdata,order=or,xreg=xregfit,fixed=fixb,transform.pars = FALSE,io=c(33,101));
        #fittedValueTmp<-fitted(tsam.bestfit)
        #print(tsam.bestfit);
        #tsam.bestfit$coef<-tsam.bestfit$coef[1:(length(tsam.bestfit$coef)-2)]
    #}else if(ti==8)
...
legend(x="topleft",legend=c("observed","arima+lm"),lty=1:9,col=1:9)
#plot(as.zoo(cbind(total.fore.tsam.xts)),col=1:9,lty=1:9,screens=1)
#legend(x="topleft",legend=c("arima+lm"),lty=1:9,col=1:9)
