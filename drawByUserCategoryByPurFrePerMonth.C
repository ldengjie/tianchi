{
    ...
    for( int upti=0 ; upti<28367 ; upti++ )
    {
        ...
        if(frePerDay[upti]>0.) frePerDayH->Fill(int(frePerDay[upti]*31));
    }
    const int cateNum=4;
    //Long64_t cateEdge[cateNum]={0,1000000,3000000,5000000,7000000,9000000,11000000,700000000};//fen
    double cateEdge[cateNum]={0,5,26,32};//fen
    ...
    for( int upti=0 ; upti<28367 ; upti++ )
    {
        ...
        {
            cout<<"frePerDay[upti]  : "<<frePerDay[upti]<<endl;
            if(  frePerDay[upti]>cateEdge[cateNum-1]/30)
            {
                cout<<"find one !!!! "<<endl;
                break;
            }
            ...
            if( frePerDay[upti]>cateEdge[catei]/30&&frePerDay[upti]<=cateEdge[catei+1]/30 )
            {
